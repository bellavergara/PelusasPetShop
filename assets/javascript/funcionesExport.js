    ...
    <div class="card-body">
        <div id="textCard">
          ...
          <div class="d-flex justify-content-around aling-items-center ">
            <a href="#" class="btn btn-outline-success m-2">Comprar</a>
            
            <a href="../html/verProducto.html" class="btn btn-outline-success m-2">Ver <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
