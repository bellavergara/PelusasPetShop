export function crearCardToys(listaDejuguetes) {
    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-around">
        <a href="#" class="btn btn-outline-success" data-_id = "${jueguete._id}">Comprar</a>
        <a href="../html/verProducto.html?id=${jueguete._id}" class="btn btn-outline-success ">Ver <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
