...
function mostrarFarmacia(array){
    ...
    farmacos.forEach(element => {
        ...
        <a href="./verProducto.html?id=${element._id}" class="btn btn-outline-success ">Ver <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
