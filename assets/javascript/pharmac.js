...
function mostrarFarmacia(array){
    ...
    farmacos.forEach(element => {
        ...
        <img src="${element.imagen}" id="${element._id}" class="figure-img img-fluid rounded p-2 " alt="${element.producto}">
        </div>
        <div class="card-body">
        <div id="textCard">
        ...
        <a href="../html/verProducto.html?id=${element._id}" class="btn btn-outline-success ">Ver <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
